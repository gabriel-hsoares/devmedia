      ...
      <div className="limita-largura">
          ...
          <div className="cards">
            <div className="card">
              ...
              <img alt='Imagem Vida Individual' src={require('../../assets/vida-individual.png')}/>
            ...
            <div className="card">
              <h3>vida em grupo</h3>
              <img alt='Imagem Vida em Grupo' src={require('../../assets/vida-em-grupo.png')}/>
            ...
            <div className="card">
              <h3>saúde</h3>
              <img alt='Imagem Saúde' src={require('../../assets/saude.png')}/>
            ...
            <div className="card">
              <h3>Consórcio</h3>
              <img alt='Imagem Consórcio' src={require('../../assets/consorcio.png')}/>
            ...
            <div className="card">
              <h3>Automóvel</h3>
              <img alt='Imagem Auto' src={require('../../assets/auto.png')}/>
            ...
            <div className="card">
              <h3>Residencial</h3>
              <img alt='Imagem Residência' src={require('../../assets/residencial.png')}/>
            ...
            <div className="card">
              <h3>Empresa</h3>
              <img alt='Imagem Empresa' src={require('../../assets/empresa.png')}/>
            ...
            <div className="card">
              <h3>Transporte</h3>
              <img alt='Imagem Transporte' src={require('../../assets/transport.png')}/>
            ...
            <div className="card">
              ...
              <img alt='Imagem Previdência' src={require('../../assets/previdencia.png')}/>
            ...
            <div className="card">
              <h3>Bike</h3>
              <img alt='Imagem Bike' src={require('../../assets/bike.png')}/>
              <p>O melhor seguro para proteger o seu bem na hora de praticar o seu hobby favorito: pedalar! Conheça as opções.</p>
            ...
            <div className="card">
              <h3>Não encontrou?</h3>
              <img alt='Imagem Dúvida' src={require('../../assets/quest.png')}/>
